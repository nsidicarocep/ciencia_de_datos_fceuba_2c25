# Ejercicios resueltos -- Practica Tidyverse EPH 
...
t1 <- eph_usuarios %>% 
  select(CODUSU,NRO_HOGAR,COMPONENTE,CH04,CH06,NIVEL_ED,CH15,ESTADO,P21,PONDERA) %>% # Seleccion de variables 
  filter(CH06 >= 25) # Filtrado 
...
# Se debe ponderar cada calculo, ya que la muestra de la EPH no está perfectamente balanceada
# Algunas personas encuestadas son más representativas que otras 
# PONDERA sirve para asignarle un peso distinto a cada observación
